...
class VSEditSecteurScreen extends GetWidget<VSEditSecteurController> {
  @override
            ...
            appBar: AppBar(
              ...
              title: Row(
                  ...
                  children: [
                    ...
                    Spacer(),
                    Text(AppLocalizations.of(Get.context!)!.modifier_secteur,
        ...
        child: Center(
          child: Text(
            AppLocalizations.of(Get.context!)!
                .ajouter_des_blocs_avant_modification,
            style: Theme.of(context).textTheme.bodyMedium,
          ),
        ),
      );
