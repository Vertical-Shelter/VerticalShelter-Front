...
class ClimbingLocationNewSect extends StatelessWidget {
  final ClimbingLocationMinimalResp climbingLocationMinimalResp;

  const ClimbingLocationNewSect(this.climbingLocationMinimalResp, {super.key});
    ...
    return Row(
      ...
      children: [
        ...
        Column(
            ...
            children: [
              Text(
                AppLocalizations.of(context)!.un_secteur_vient_douvrir,
