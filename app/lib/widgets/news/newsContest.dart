...
class NewsContest extends StatelessWidget {
  final UserNewsResp userNewsResp;

  const NewsContest(this.userNewsResp, {super.key});

  @override
  Widget build(BuildContext context) {
    return InkWell(
        onTap: () => Get.toNamed(AppRoutesVT.contestList),
        child: Row(
          ...
          children: [
            ...
            Column(
                ...
                children: [
                  Text(
                    '${AppLocalizations.of(context)!.nouveau_contest} : ' + userNewsResp.contest_id!.title!,
